...
//mport "github.com/OpenZeppelin/openzeppelin-contracts/blob/release-v3.3/contracts/utils/ReentrancyGuard.sol";
//Ref: https://itnext.io/uni-directional-payment-channels-in-solidity-1aab8cc7eda9

contract OnewayPayment is ReentrancyGuard {
    ...
    function accept(uint _amount, bytes memory _sig) external nonReentrant {
        //  verifing signature and sender != receiver
        //  require(msg.sender == receiver, "sender must be different than receiver");
        require(msg.sender == receiver, "only receiver can accept this payment.");
